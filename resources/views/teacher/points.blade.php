...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom gap-2">
    <h1 class="h2 mb-0">ポイント購入管理</h1>
    <div class="d-flex gap-2 flex-wrap">
        <a href="/teacher/points/history/personal" class="btn btn-outline-primary btn-sm">個人履歴</a>
        <a href="/teacher/points/history/period" class="btn btn-outline-primary btn-sm">日次 / 月次履歴</a>
    </div>
</div>
...
<script>
    ...
    async function loadRequests() {
        try {
            ...
            showAlert('danger', error.message || '読み込みに失敗しました');
