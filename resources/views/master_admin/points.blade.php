...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom gap-2">
    ...
    <div class="d-flex gap-2 flex-wrap">
        <a href="/master/points/history/personal" class="btn btn-outline-primary btn-sm">個人履歴</a>
        <a href="/master/points/history/period" class="btn btn-outline-primary btn-sm">日次 / 月次履歴</a>
    </div>
</div>
